  ...
  async function send(customQ?: string) {
    ...
    try {
      ...
      setLogs((l) => [
        ...
        {
          role: "assistant",
          text: "⚠️ Gagal menghubungi server. Silakan coba lagi.",
        },
      ]);
    } finally {
      setLoading(false);
  ...
  const templates = [
    {
      ...
      questions: ["Tampilkan perkembangan SDG 6 Air Bersih"],
    },
    {
      category: "Analisis Data",
      questions: ["Bandingkan progress SDG 4 dan SDG 8"],
    },
    {
              ...
              {logs.map((m, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="text-sm leading-relaxed font-sans text-white">
                      {/* @ts-expect-error: ReactMarkdown typing issue */}
